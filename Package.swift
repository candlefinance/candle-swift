...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            path: "./XCFrameworks/CNIOBoringSSLShims.xcframework"
        ...
        .binaryTarget(
            ...
            path: "./XCFrameworks/NIOConcurrencyHelpers.xcframework"
        ...
        .binaryTarget(
            ...
            path: "./XCFrameworks/NIOFoundationCompat.xcframework"
        ...
        .binaryTarget(
            ...
            path: "./XCFrameworks/NIOTransportServices.xcframework"
        ...
        .binaryTarget(
            ...
            path: "./XCFrameworks/OpenAPIURLSession.xcframework"
        ...
        .binaryTarget(
            ...
            path: "./XCFrameworks/_NIODataStructures.xcframework"
        ),
    ]
)
